...
(function () {
    ...
    jQuery.sap.declare("sap.ushell.adapters.signal.PersonalizationAdapter");
    jQuery.sap.require("sap.ushell.shells.signal.fioriDemoConfig");


    var oDemoPersData = sap.ushell.shells.signal.fioriDemoConfig.personalizationData || {};
     ...
     * @since 1.15.0
     */
    sap.ushell.adapters.signal.PersonalizationAdapter = function (oSystem) {
        // rebind demo data with every invoke! 
        oDemoPersData = sap.ushell.shells.signal.fioriDemoConfig.personalizationData  || {};
    };
     ...
     * @since 1.15.0
     */
    sap.ushell.adapters.signal.PersonalizationAdapter.prototype.readPersData = function (oPersId) {
    ...
    * @param {Object} oPersId 
     ...
     * @since 1.15.0
     */
    sap.ushell.adapters.signal.PersonalizationAdapter.prototype.writePersData = function (oPersId, oValue) {
        var oDeferred = new jQuery.Deferred(),
    ...
    * @param {Object} oPersId 
     ...
     * @since 1.15.0
     */
    sap.ushell.adapters.signal.PersonalizationAdapter.prototype.delPersData = function (oPersId) {
        var oDeferred = new jQuery.Deferred(),
    ...
    // ----
    sap.ushell.adapters.signal.PersonalizationAdapter.prototype.getAdapterContainer = function (sContainerKey) {
        return new sap.ushell.adapters.signal.AdapterContainer(sContainerKey);
    };
     ...
     */
    sap.ushell.adapters.signal.PersonalizationAdapter.prototype.delAdapterContainer = function (sContainerKey) {
    ...
    // --- Adapter Container ---
    sap.ushell.adapters.signal.AdapterContainer = function (sContainerKey) {
        this._sContainerKey = sContainerKey;
        this._oPersData = oDemoPersData;  // global! 
        this._oLocalStorage = false;
    };
    sap.ushell.adapters.signal.AdapterContainer.prototype.load = function () {
        var oDeferred = new jQuery.Deferred();
        this._oLocalStorage = true;
        oDeferred.resolve();
        return oDeferred.promise();
    };
    sap.ushell.adapters.signal.AdapterContainer.prototype.save = function () {
        var oDeferred = new jQuery.Deferred();
        oDeferred.resolve();
        return oDeferred.promise();
    };
    sap.ushell.adapters.signal.AdapterContainer.prototype.getItemKeys = function () {
        return keysPersData(this._oPersData, { container : this._sContainerKey });
    };
    sap.ushell.adapters.signal.AdapterContainer.prototype.containsItem = function (sItemKey) {
        return containsPersData(this._oPersData, { container : this._sContainerKey, item : sItemKey });
    };
    sap.ushell.adapters.signal.AdapterContainer.prototype.getItemValue = function (sItemKey) {
        return readPersData(this._oPersData, { container : this._sContainerKey, item : sItemKey });
    };
    sap.ushell.adapters.signal.AdapterContainer.prototype.setItemValue = function (sItemKey, oItemValue) {
        return writePersData(this._oPersData, { container : this._sContainerKey, item : sItemKey }, oItemValue);
    };
    sap.ushell.adapters.signal.AdapterContainer.prototype.delItem = function (sItemKey) {
