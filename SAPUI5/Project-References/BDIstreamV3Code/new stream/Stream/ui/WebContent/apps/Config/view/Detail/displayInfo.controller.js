sap.ui.core.mvc.Controller.extend("sap.rds.bdi.stream.config.view.Detail.displayInfo", {
    ...
    refreshTable: function() {
		...
		sap.ui.getCore().byId("oDetailTable").setModel(myModel);
		sap.ui.getCore().byId("oDetailTable").bindRows("/Data");
