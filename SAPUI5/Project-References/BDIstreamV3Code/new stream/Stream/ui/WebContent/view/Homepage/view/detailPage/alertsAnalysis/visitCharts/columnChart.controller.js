sap.ui.controller("sap.rds.bdi.stream.Homepage.view.detailPage.alertsAnalysis.visitCharts.columnChart", {
    ...
    refreshChart: function(dimen) {
        ...
        if(result.status) {
            ...
            console.log("No data ------- getChartData() ------ [location: Homepage/view/detailPage/alertsAnalysis/columnChart.ctl.js]");
        }
        ...
        this.dataset = new sap.viz.ui5.data.FlattenedDataset({
            ...
            measures: [{
                name: oBundle.getText("alerts.analysis.chart.visits"), 
                value: '{Access}'   
            }],
            data: {
                path: "/businessData"
