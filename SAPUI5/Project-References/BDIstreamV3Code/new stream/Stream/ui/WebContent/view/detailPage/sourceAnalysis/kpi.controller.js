sap.ui.controller("sap.rds.bdi.stream.Homepage.view.detailPage.sourceAnalysis.kpi", {
    ...
    refreshKpi: function() {
        ...
        if(result.status) {
            ...
            console.log("No data -- getKpiData() - [location: Homepage/view/detailPage/SourceAnalysis/kpi.ctl.js]");
