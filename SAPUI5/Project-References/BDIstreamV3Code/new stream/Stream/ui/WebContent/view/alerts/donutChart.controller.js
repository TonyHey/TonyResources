sap.ui.controller("sap.rds.bdi.stream.Homepage.view.alerts.donutChart", {
    ...
    getChartData: function(dimen, that) {
        ...
        switch(dimen) {
            ...
            default:
                console.log("Error! No dimensions of " + dimen + " [location: Homepage/view/alerts/donutChart.ctl.js]");
                return false;
        }
