sap.ui.controller("sap.rds.bdi.stream.Homepage.view.detailPage.sourceAnalysis.visitDurationCharts.donutChart", {

    onBeforeRendering: function() {
        var page = sap.ui.getCore().byId("sourceAnalysis");
        var chartContent = page.getContent()[1];

        if (chartContent.getId() === "sourceVDChartView") {
            ...
            sap.ui.getCore().byId("sourceVisitChartApp").backToTop();
    ...
    onAfterRendering: function() {
     ...
     refreshChart: function() {
         ...
         var visitSelector = sap.ui.getCore().byId("sourceVisitDurationSelected");
         ...
         if (result.status) {
             ...
             console.log("No data ------- getChartData() ------ [location: Homepage/view/detailPage/sourceAnalysis/visitDurationCharts/donutChart.ctl.js]");
         }
         ...
         this.dataset = new sap.viz.ui5.data.FlattenedDataset({
                ...
                measures: [ {
                    name: oBundle.getText("source.analysis.chart.percent"),
                    value: '{VISITS_DURATION_PERCENT}'
                } ],
                data: {
                    path: "/businessData"
                }
        ...
        getChartData: function(dimen) {
            ...
            switch(dimen) {
                ...
                default:
                    console.log("Error! No dimensions of " + dimen + " [location: Homepage/view/detailPage/sourceAnalysis/donutChart.ctl.js]");
                    return false;
            }
