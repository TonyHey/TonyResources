sap.ui.controller("sap.rds.bdi.stream.Homepage.view.detailPage.demographicAnalysis.visitDurationCharts.map", {
    markers : [],
    map : null,
    infoBubbles : null,
    drawpoly : "drawPoly",
    ...
    onAfterRendering: function() {
        ...
        this.map = new nokia.maps.map.Display(document.getElementById("mapContainerDVD"), {
            zoomLevel: 5,
            center: myCenter,
            components: [
        ...
        this.toolKit.placeAt("polygonToolDVD", "only");
    ...
    getMapData: function() {
        ...
        var selectOpt = sap.ui.getCore().byId("demographicVisitDurationSelected").getSelectedKey();
        ...
        if (selectOpt == "AgeRange") {
            this.oService = "ui/xsjs/api.xsjs/intelligence/getVDAvgAgeMap?after=" + afterDate +
            "&before=" + beforeDate + "&serverIP=" + this.serverIP;

            this.oServer = "ui/xsjs/api.xsjs/intelligence/getSrvVDAvgAgeMap?after=" + afterDate +
            "&before=" + beforeDate + "&serverIP=" + this.serverIP;
        } else {
            this.oService = "ui/xsjs/api.xsjs/intelligence/getVDAvgGenderMap?after=" + afterDate +
            "&before=" + beforeDate + "&serverIP=" + this.serverIP;

            this.oServer = "ui/xsjs/api.xsjs/intelligence/getSrvVDAvgGenderMap?after=" + afterDate +
            "&before=" + beforeDate + "&serverIP=" + this.serverIP;
        }
    ...
    refreshData : function() {
        ...
        sap.ui.getCore().byId("demographicVisitDurationKpiValue").setText(util.numberToHourString(kpiValue));
    },
    ...
    loadMarkers : function() {
        ...
        var markerMouseoverHandler = function (evt) {
            ...
            function generateBusyIndicator() {
                var busyIndicator = document.getElementById("busyIndicatorDVD");
                if(!busyIndicator){
                    $("body").append("<div id='busyIndicatorDVD'></div>");
                    (new sap.m.BusyIndicator()).placeAt("busyIndicatorDVD", "only");
                    busyIndicator = document.getElementById("busyIndicatorDVD")
                }
