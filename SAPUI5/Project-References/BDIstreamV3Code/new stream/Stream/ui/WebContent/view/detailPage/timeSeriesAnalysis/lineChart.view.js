sap.ui.jsview("sap.rds.bdi.stream.Homepage.view.detailPage.timeSeriesAnalysis.lineChart", {

	getControllerName : function() {
		return "sap.rds.bdi.stream.Homepage.view.detailPage.timeSeriesAnalysis.lineChart";
	},
