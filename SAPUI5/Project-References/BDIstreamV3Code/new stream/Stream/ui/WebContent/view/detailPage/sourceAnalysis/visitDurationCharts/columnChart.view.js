sap.ui.jsview("sap.rds.bdi.stream.Homepage.view.detailPage.sourceAnalysis.visitDurationCharts.columnChart", {

    getControllerName: function() {
        return "sap.rds.bdi.stream.Homepage.view.detailPage.sourceAnalysis.visitDurationCharts.columnChart";
    },
    ...
    createContent: function(oController) {
        ...
        oController.columnChart = new sap.viz.ui5.Column({
            ...
            title: new sap.viz.ui5.types.Title ({
                visible: true,
                text: oBundle.getText("source.analysis.chart.visits.duration"),
