sap.ui.controller("sap.rds.bdi.stream.Homepage.view.detailPage.demographicAnalysis.visitCharts.columnChart", {
    ...
    refreshChart: function() {
        ...
        if(result.status) {
            ...
            console.log("No data ------- getChartData() ------ [location: Homepage/view/detailPage/demographicAnalysis/visitCharts/columnChart.ctl.js]");
        }
        ...
        this.dataset = new sap.viz.ui5.data.FlattenedDataset({
            ...
            measures: [ {
                name: oBundle.getText("demographic.analysis.visits"),
                value: '{VISITS}'
            } ],
            data: {
                path: "/businessData"
    ...
    getChartData: function(dimen) {
        ...
        switch(dimen) {
            ...
            default:
                console.log("Error! No dimensions of " + dimen + " [location: Homepage/view/detailPage/demographicAnalysis/visitCharts/columnChart.ctl.js]");
                return false;
        }
