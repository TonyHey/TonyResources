sap.ui.controller("sap.rds.bdi.stream.Homepage.view.detailPage.userNavigationAnalysis.barChart", {

	onInit: function() {
        var defaultMeasure = "User";
    ...
    refreshChart: function(measure) {
        ...
        if(result.status) {
            ...
            console.log("No data ------- getChartData() ------ [location: Homepage/view/detailPage/userNavigationAnalysis/barChart.ctl.js]");
        }
        ...
        this.dataset = new sap.viz.ui5.data.FlattenedDataset({
            ...
            measures: [ {
                name: oBundle.getText("user.navigation.analysis.visits"),
                value: "{Visits}"
            } ],
            data: {
                path: "/businessData"
    ...
    getChartData: function(measure) {
        ...
        switch(measure) {
            ...
            case "Page":
                ...
                break;
            default:
                console.log("Error! No measures of " + measure + " [location: Homepage/view/detailPage/userNavigationAnalysis/barChart.ctl.js]");
                return false;
        }
