sap.ui.controller("sap.rds.bdi.stream.Homepage.view.detailPage.sourceAnalysis.visitDurationCharts.columnChart", {
    ...
    refreshChart: function() {
        ...
        if(result.status) {
            ...
            console.log("No data ------- getChartData() ------ [location: Homepage/view/detailPage/sourceAnalysis/visitDurationCharts/columnChart.ctl.js]");
        }
        ...
        this.dataset = new sap.viz.ui5.data.FlattenedDataset({
            ...
            measures: [ {
                name: oBundle.getText("source.analysis.chart.visits.duration"),
