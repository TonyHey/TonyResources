sap.ui.controller("sap.rds.bdi.stream.Homepage.view.detailPage.sourceAnalysis.visitCharts.map", {
    markers : [],
    map : null,
    infoBubbles : null,
    drawpoly : "drawPoly",
    ...
    onAfterRendering: function() {
        ...
        this.map = new nokia.maps.map.Display(document.getElementById("sourceVisitMapContainer"), {
            zoomLevel: 5,
            center: myCenter,
            components: [
        ...
        this.toolKit.placeAt("polygonToolSV", "only");
    ...
    getMapData: function() {
        ...
        if (selectOpt === "Site") {
            this.oService = "ui/xsjs/api.xsjs/intelligence/getVisitsOriginMap?after=" + afterDate +
            "&before=" + beforeDate + "&serverIP=" + this.serverIP;

            this.oServer = "ui/xsjs/api.xsjs/intelligence/getSrvVisitsOriginMap?after=" + afterDate +
            "&before=" + beforeDate + "&serverIP=" + this.serverIP;
        } else {
            this.oService = "ui/xsjs/api.xsjs/intelligence/getVisitsBrowserMap?after=" + afterDate +
            "&before=" + beforeDate + "&serverIP=" + this.serverIP;

            this.oServer = "ui/xsjs/api.xsjs/intelligence/getSrvVisitsBrowserMap?after=" + afterDate +
            "&before=" + beforeDate + "&serverIP=" + this.serverIP;
        } 
    ...
    refreshData : function() {
        ...
        sap.ui.getCore().byId("sourceVisitKpiValue").setText(kpiValue);
    },
    ...
    loadMarkers : function() {
        ...
        var markerMouseoverHandler = function (evt) {
            ...
            function generateBusyIndicator() {
                var busyIndicator = document.getElementById("busyIndicatorSV");
                if(!busyIndicator){
                    $("body").append("<div id='busyIndicatorSV'></div>");
                    (new sap.m.BusyIndicator()).placeAt("busyIndicatorSV", "only");
                    busyIndicator = document.getElementById("busyIndicatorSV")
                }
