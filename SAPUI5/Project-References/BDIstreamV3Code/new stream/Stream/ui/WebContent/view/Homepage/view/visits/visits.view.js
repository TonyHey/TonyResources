sap.ui.jsview("sap.rds.bdi.stream.Homepage.view.visits.visits", {
    ...
    createContent : function(oController) {
        ...
        console.log("Tracing i18n");
    	console.log(sap.ui.getCore().getModel("i18n"));
        
        var tileTitle = new sap.m.Link({
//            text: oBundle.getText("homepage.tile.title.visits"),
//        	text: sap.ui.getCore().getModel("i18n").getResourceBundle().getText("homepage.tile.title.visits"),
        	
        	text: "{i18n>/homepage.tile.title.visits}",
            press: function(){
                that.toDetailPage();
            }
