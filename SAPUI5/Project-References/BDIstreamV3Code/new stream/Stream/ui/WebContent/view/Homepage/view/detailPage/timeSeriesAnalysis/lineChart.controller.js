sap.ui.controller("sap.rds.bdi.stream.Homepage.view.detailPage.timeSeriesAnalysis.lineChart", {

	onInit: function() {
		
		this.refreshChartData("Unique Visitors");
	},

	refreshChartData: function(kpiTitleData){
      ...
      this.getLineChartData(this.oService, this);
      this.handleMonthData(this);

      this.oModel = new sap.ui.model.json.JSONModel();    
      this.oModel.setData(this.currentData);
      //check data path
	...
	getLineChartData: function(sServiceUrl, oController) {
        jQuery.ajax({
            url: sServiceUrl,
            dataType: 'json',
            async : false,
            ...
            success: function(oResponse, textStatus, jqXHR) {
                ...
                oController.currentData = oResponse; 
            },
